...
// Declare formatPrice and formatLargeNumber functions
const formatPrice = (price: number) => `$${price.toFixed(2)}`
const formatLargeNumber = (number: number) => `${(number / 1000000).toFixed(2)}M`
...
export default function ToncoinPricePage() {
    ...
    const fetchCoinData = async () => {
      try {
        ...
        setCoinData({
          ...
          circulating_supply: 3470000000,
          max_supply: 5000000000,
          ath: 8.25,
          ath_change_percentage: -70.3,
          ath_date: "2021-11-09T00:00:00.000Z",
          atl: 0.519,
          atl_change_percentage: 372.1,
        ...
        <Card className="backdrop-blur-xl bg-white/10 border border-white/20 text-white mb-8">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-300 leading-relaxed">
              ...
              originally developed by Telegram. TON is designed to process millions of transactions per second through
              its unique multi-blockchain architecture and dynamic sharding technology.
            </p>
            <p className="text-gray-300 leading-relaxed">
              The TON blockchain features a proof-of-stake consensus mechanism and supports smart contracts,
              decentralized applications (dApps), and various DeFi protocols. With its focus on scalability and
              user-friendly applications, TON aims to bridge the gap between traditional internet services and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div className="p-4 bg-white/5 rounded-lg">
                ...
                <ul className="text-sm text-gray-300 space-y-1">
                  <li>• Multi-blockchain architecture</li>
                  <li>• Dynamic sharding</li>
                  <li>• Proof-of-Stake consensus</li>
                  <li>• High throughput (millions TPS)</li>
                </ul>
              </div>
              <div className="p-4 bg-white/5 rounded-lg">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-sm text-gray-400">ton.org</p>
              </a>
              <a
              ...
              <a
                ...
                className="p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors"
              >
                <h4 className="font-semibold mb-2">Telegram Community</h4>
                <p className="text-sm text-gray-400">Official Telegram channel</p>
              </a>
            </div>
          </CardContent>
        </Card>
